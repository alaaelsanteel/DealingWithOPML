...
namespace DealingWithOPML.Pages
{
    public class IndexModel : PageModel
    {
        ...
        {
            RssList = new List<RssItem>();

            var httpClient = _httpClientFactory.CreateClient();
            HttpResponseMessage opmlResponse = await FetchXmlContentAsync(httpClient, "https://blue.feedland.org/opml?screenname=dave");
        ...
        async Task<List<RssItem>> FetchAndParseRssFeedAsync(HttpClient httpClient, string url)
        {
            ...
            HttpResponseMessage response = await FetchXmlContentAsync(httpClient, url);
